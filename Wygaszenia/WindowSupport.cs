...
namespace Wygaszenia
{
    public class WindowSupport
    {
        ...
        protected void DeviceReset()
        {
            ...
            mSimpleEffect.Projection = mCamera.Projection;
            //Matrix.CreateOrthographicOffCenter(0, service.GraphicsDevice.Viewport.Width, service.GraphicsDevice.Viewport.Height, 0, 0, 1);
